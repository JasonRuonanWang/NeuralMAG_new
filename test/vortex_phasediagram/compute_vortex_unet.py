...
if __name__ == '__main__':
    ...
    parser.add_argument('--nstart',   type=int,    default=100,       help='sample number (default: 100)')
    ...
    # Random seed list
    seeds_list = list(range(10000, 110000, 100))[args.nstart:args.nstart+args.nsamples]
