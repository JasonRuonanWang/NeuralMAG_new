...
if __name__ == '__main__':
    ...
    parser.add_argument('--model',       type=str,    default="new",     help='model type (new/original) (default: new)')
    ...
    parser.add_argument('--deg',         type=int,    default=0.1,         help='degree of freedom (default: 0.1)')
    ...
    parser.add_argument('--experiment',  type=str,    default="square",  help='experiment type (default: square)')
    ...
    for seed in seeds_list:
        subpath = "split{}_rand{}/".format(args.split, seed)
    ...
    path_save="./analyze_vortex/{}/size{}_{}/".format(args.model, args.w, ex_type)
